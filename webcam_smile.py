...
def detect_webcam():
    ...
    parser.add_argument('--weights_path', type=str, default='weights/57.weights', help='path to weights file')
    ...
    color_list = [(128, 255, 0), (51, 153, 255)]
    ...
    while True:
        ...
        if detections is not None:
            ...
            for x1, y1, x2, y2, conf, cls_conf, cls_pred in detections:
                ...
                if (classes[int(cls_pred)] == "nonsmile"):
                    color = color_list[0]
                ...
                elif (classes[int(cls_pred)] == "smile"):
                    color = color_list[1]
